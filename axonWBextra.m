function v = axonWBextra(Iinj,Rc,dt,Nc,Dc,Lc,Ic)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Axonal spike conduction simulated with Wang-Buzsaki model 
% stimulated by extracellular current
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input 
...
trfE = rhoE ./ ( 4 * pi * Rc ); % [kOhm] transfer function between node and stim
